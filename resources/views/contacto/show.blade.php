...
@section('title', 'Contacto: '. $contacto->nome)
...
<form  method="post" action="{{route('contactos.update', $contacto->id)}}">
    ...
    <div class="row form-group">
        <div class="col-md-4">
            ...
            <input type="text" id="nome" name="nome" placeholder="Nome do contacto" value="{{$contacto->nome}}" class="form-control">
        ...
        <div class="col-md-4">
            ...
            <input type="text" id="contacto" name="contacto" placeholder="Número de contacto" value="{{$contacto->contacto}}" class="form-control">
            <small class="form-text text-muted">Digite o número de contacto</small>
        </div>
        <div class="col-md-4">
            <label for="email" class=" form-control-label">Email</label>
            <input type="email" id="email" name="email" placeholder="Digite o email" value="{{$contacto->email}}" class="form-control">
